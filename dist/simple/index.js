...
class AuthRole {
    constructor(jwtService = new jwt_service_1.JwtService()) {
        ...
        this.refetchToken = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const refreshTokenRedis = yield redisio_db_1.falcol.get(`refreshToken:${_id}`);
                ...
                // add redis
                void redisio_db_1.falcol.set(`refreshToken:${_id}`, newRefreshToken);
                void redisio_db_1.falcol.expire(`refreshToken:${_id}`, 2592000);
                // add header
        ...
        this.isUser = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (authorization) {
                ...
                try {
                    ...
                    const User = (0, models_1.getModel)('User');
